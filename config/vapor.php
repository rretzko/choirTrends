...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Signed Storage URL Middleware
    |--------------------------------------------------------------------------
    |
    | These middleware will be assigned to the signed storage URL route. This
    | should include 'web' for session/CSRF support, and 'auth' to ensure
    | only authenticated users can request signed upload URLs.
    |
    */
