        ...
        <section class="relative overflow-hidden">
            ...
            <div class="max-w-6xl mx-auto px-6 pt-20 pb-16 lg:pt-28 lg:pb-24">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <a href="https://choirtrends.s3.us-east-1.amazonaws.com/mp4s/ElevenLabs_ChoirTrends.mp4" target="_blank" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 dark:bg-white/5 border border-teal-300/40 dark:border-teal-600/40 text-teal-700 dark:text-teal-300 text-sm font-medium hover:bg-teal-50 dark:hover:bg-teal-950/50 transition-colors backdrop-blur-sm my-6">
