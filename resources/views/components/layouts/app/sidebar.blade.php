    ...
    <body class="min-h-screen bg-blue-100 dark:bg-zinc-800">
        <flux:sidebar sticky collapsible class="border-e border-zinc-200 bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.item icon="academic-cap" :href="route('schools.index')" :current="request()->routeIs('schools.*')" wire:navigate>{{ __('Schools/Orgs') }}</flux:sidebar.item>
                ...
                <flux:sidebar.group expandable :expanded="false" icon="book-open" heading="Documentation" class="grid">
                    ...
                    <flux:sidebar.item icon="academic-cap" :href="route('documentation.schools-guide')" :current="request()->routeIs('documentation.schools-guide')" wire:navigate>{{ __('Schools/Orgs Guide') }}</flux:sidebar.item>
