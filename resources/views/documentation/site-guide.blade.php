                ...
                <div class="mt-4 space-y-3">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('Browse all submitted concert programs. Filter the program selections by one, many or all schools.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('Upload a photo or PDF of a concert program. Our AI extracts the details automatically.  Note: Your student rosters are NOT uploaded.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('Explore the composers and arrangers found across all programs.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('View the performing ensembles from submitted programs.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('See the schools associated with programs and directors.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('Discover the most popular song titles across all programs.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('Send us feedback, report a bug, or suggest a feature.') }}</flux:text>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <flux:text class="text-sm">{{ __('Toggle between light and dark themes.') }}</flux:text>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="mt-4 space-y-3">
                    ...
                    <div>
                        ...
                        <flux:text class="text-sm">{{ __('Use the My/All buttons to switch between your data and all community data. Search bars let you filter by keyword.') }}</flux:text>
                    </div>
                    <div>
                        <flux:text class="font-semibold">{{ __('Edit Icons') }}</flux:text>
                        <flux:text class="text-sm">{{ __('Look for the pencil icon on items you own to make edits.') }}</flux:text>
                    </div>
                </div>
            </section>
